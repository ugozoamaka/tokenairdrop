    ...
    try {
      ...
      setClaimMessage({
        ...
        payload: `
          ...
          Total Amount: ${Web3.utils.fromWei(response.data.totalAllocation.toString())} $BET
          -> Basic allocation: ${Web3.utils.fromWei(response.data.basicAllocation.toString())} $BET
          -> Bonus allocation: ${Web3.utils.fromWei(response.data.bonusAllocation.toString())} $BET
        `
      });
...
Reason" Airdrop already sent to ${address}`
  ...
  return (
    <div className='container'>
      <Head>
        <title>Blockchain Empire Airdrop</title>
      ...
      <div className='row mt-4'>
        <div className='col-sm-12'>
          <div className="jumbotron">
            <h1 className='text-center'>Blockchain Empire Airdrop</h1>
          </div>
        </div>
      </div>
            ...
            <div className="card-body">
              ...
              <div className="card-text">
                <ul>
                  ...
                  <li>Step 4: Confirm the transaction to claim your $BET tokens. This will send a transaction to the Airdrop smart contract</li>
                </ul>
              </div>
            </div>
          </div>
